...
🔹 Developed a digital twin of a fictional Samsung-style consumer electronics manufacturer.

🔹 Simulated product demand, inventory planning, production, pricing, and supply chain operations using realistic business scenarios.

🔹 Built a business simulation framework to evaluate market trends and support strategic planning.

Key Insights
Simulated demand across multiple consumer electronics product categories.
Evaluated product portfolio performance and revenue contribution.
...
🔹 Built a supply chain intelligence framework for vendor benchmarking and operational performance analysis.

🔹 Developed transparent scoring models for supplier performance, logistics efficiency, inventory health, and cost optimization.

🔹 Applied Machine Learning to product segmentation and supplier risk assessment for data-driven sourcing decisions.

Key Insights
Benchmarked suppliers using explainable performance metrics.
Identified sourcing risks through clustering and risk classification.
...
🔹 Built an end-to-end PostgreSQL ETL pipeline to clean, transform, and prepare e-commerce sales data for analysis.

🔹 Developed an interactive Power BI dashboard to analyze category performance, regional sales distribution, customer purchasing behaviour, and business trends.
...
Vendor Benchmarking & Competitive Analysis
Supply Chain Intelligence
Consumer Demand & Seasonality Analysis
